...
The Active Directory Home Lab project was created to showcase hands-on experience with Windows Server administration and common Tier 1 IT support tasks. The lab documents practical work with Active Directory, including deploying AD DS, joining Windows clients to a domain, managing users, configuring account policies, and unlocking accounts.
...
*Ref 1: Installing the AD DS role*
...
*Ref 2: Confirming successful AD DS installation* 

### User Account Management
Created and managed domain user accounts through ADUC.
...
*Ref 4: Confirming new user account creation*
...
*Ref 5: Joining a Windows 10 client to the domain*
...
*Ref 6: Confirming successful Windows 10 client domain connectivity* 
...
*Ref 7: Joining a Windows 11 client to the domain*
...
*Ref 8: Confirming successful Windows 11 client domain connectivity*
...
*Ref 9: Confirming both clients were successfully added to the domain*
...
*Ref 12: Changing account lockout duration to 360 minutes*
...
*Ref 14: Confirming the user account is locked*
...
*Ref 15: Unlocking the user account*
...
Enabled Remote Desktop and successfully connected to Windows Server from a domain-joined Windows client.
...
*Ref 17: Enabling RDP connections on Windows Server*
...
*Ref 20: Confirming successful RDP connection*
